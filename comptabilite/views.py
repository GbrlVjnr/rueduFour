...
def facturation(request, year, month):
    ...
    for account in accounts:
        ...
        black_and_white_expense = prints.get(type="B&W").amount * 0.00356 * 1.2 if prints is not None else 0
        color_expense = prints.get(type="C").amount * 0.03562 * 1.2 if prints is not None else 0
